    ...
    with slim.arg_scope([slim.conv2d, slim.fully_connected],
        ...
        with tf.variable_scope('squeezenet', [images], reuse=reuse):
            with slim.arg_scope([slim.batch_norm, slim.dropout],
                ...
                net = slim.conv2d(images, 32, [3, 3], stride=1, scope='conv0')
                net = slim.conv2d(net, 96, [7, 7], stride=2, scope='conv1')
                ...
                print(net.get_shape())
                net = slim.max_pool2d(net, [2, 2], stride=[1,2], scope='maxpool8')
                #net = slim.conv2d(net, 32, [3, 3], stride=[1, 2], scope='maxpool8')
                print(net.get_shape())
