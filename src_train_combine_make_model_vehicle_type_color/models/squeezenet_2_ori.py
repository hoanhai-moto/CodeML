    ...
    with slim.arg_scope([slim.conv2d, slim.fully_connected],
        ...
        with tf.variable_scope('squeezenet', [images], reuse=reuse):
            with slim.arg_scope([slim.batch_norm, slim.dropout],
                ...
                print(net)
                fire2 = fire_module(net, 48, 192, scope='fire2')
                # print(net)
                fire3 = fire_module(fire2, 48, 192, scope='fire3')
                # print(net)
                ...
                fire6 = fire_module(net, 64, 256, scope='fire6')
                # print(net)
    ...
    with slim.arg_scope([slim.conv2d, slim.fully_connected],
        ...
        with tf.variable_scope('squz_tail_color', [images], reuse=reuse):
            with slim.arg_scope([slim.batch_norm, slim.dropout],
                ...
                # print(net)
                # net = se_block(net, "se_block_1", ratio=8)
                fire2 = fire_module(images, 48, 192, scope='fire2')
                # print(net)
                fire3 = fire_module(fire2, 48, 192, scope='fire3')
                # print(net)
                net = tf.add(fire3, fire2, name="bypass23")
