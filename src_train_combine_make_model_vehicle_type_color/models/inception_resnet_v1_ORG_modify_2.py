...
def block8(net, scale=1.0, activation_fn=tf.nn.relu, scope=None, reuse=None):
    ...
    with tf.variable_scope(scope, 'Block8', [net], reuse=reuse):
        ...
        with tf.variable_scope('Branch_1'):
            ...
            tower_conv1_1 = slim.conv2d(tower_conv1_0, 96, [1, 3],
                                        scope='Conv2d_0b_1x3')
            tower_conv1_2 = slim.conv2d(tower_conv1_1, 96, [3, 1],
                                        scope='Conv2d_0c_3x1')
        mixed = tf.concat([tower_conv, tower_conv1_2], 3)
        up = slim.conv2d(mixed, net.get_shape()[3], 1, normalizer_fn=None,
                         activation_fn=None, scope='Conv2d_1x1')
...
def reduction_b(net):
    with tf.variable_scope('Branch_0'):
        tower_conv = slim.conv2d(net, 128, 1, scope='Conv2d_0a_1x1')
        tower_conv_1 = slim.conv2d(tower_conv, 384, 3, stride=2,
                                   padding='VALID', scope='Conv2d_1a_3x3')
    with tf.variable_scope('Branch_1'):
        tower_conv1 = slim.conv2d(net, 128, 1, scope='Conv2d_0a_1x1')
        tower_conv1_1 = slim.conv2d(tower_conv1, 256, 3, stride=2,
                                    padding='VALID', scope='Conv2d_1a_3x3')
    with tf.variable_scope('Branch_2'):
        tower_conv2 = slim.conv2d(net, 128, 1, scope='Conv2d_0a_1x1')
    ...
    with tf.variable_scope(scope, 'InceptionResnetV1', [inputs], reuse=reuse):
        with slim.arg_scope([slim.batch_norm, slim.dropout],
            ...
            with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
                ...
                net = slim.conv2d(net, 20, 1, padding='VALID', scope='Conv2d_3b_1x1')

                net = slim.conv2d(net, 48, 3, padding='VALID', scope='Conv2d_4a_3x3')

                net = slim.conv2d(net, 64, 3, stride=2, padding='VALID', scope='Conv2d_4b_3x3')

                net = slim.repeat(net, 2, block35, scale=0.17)

                with tf.variable_scope('Mixed_6a'):
                    net = reduction_a(net, 48, 48, 64, 96)
