...
def inference(images, keep_probability, num_class, phase_train=True, bottleneck_layer_size=128, weight_decay=0.0, reuse=None):
    batch_norm_params = {
    ...
    with slim.arg_scope([slim.conv2d, slim.fully_connected],
        ...
        with tf.variable_scope('squeezenet', [images], reuse=reuse):
            with slim.arg_scope([slim.batch_norm, slim.dropout],
                ...
                net = slim.conv2d(net, num_class, [1, 1], activation_fn=None, normalizer_fn=None, scope='conv10')
                print (net)
