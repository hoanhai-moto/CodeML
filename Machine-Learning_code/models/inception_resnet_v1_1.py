    ...
    with tf.variable_scope(scope, 'InceptionResnetV1', [inputs], reuse=reuse):
        with slim.arg_scope([slim.batch_norm, slim.dropout],
            ...
            with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
                ...
                print(inputs)
                # 100 x 24 x 32
                net = slim.conv2d(inputs, 32, [3,3],stride=1 , scope='Conv2d_1a_3x3')
                print(net)
                ...
                # 48 x 24 x 32
                net = slim.conv2d(net, 32, 3, stride=[1,2],
                                  scope='Conv2d_2a_3x3')
                ...
                # 48 x 23x 64
                net = slim.max_pool2d(net, 3, stride=1, padding='VALID',
                                      scope='MaxPool_3a_3x3')

                end_points['MaxPool_3a_3x3'] = net
                # 73 x 73 x 80
                net = slim.conv2d(net, 80, 2,stride=1, padding='VALID',
                                  scope='Conv2d_3b_1x1')
                end_points['Conv2d_3b_1x1'] = net
                # 71 x 71 x 192
                net = slim.conv2d(net, 192, 3,stride=2, padding='VALID',
                                  scope='Conv2d_4a_3x3')
