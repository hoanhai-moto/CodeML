    ...
    with tf.variable_scope(scope, 'InceptionResnetV1', [inputs], reuse=reuse):
        with slim.arg_scope([slim.batch_norm, slim.dropout],
            ...
            with slim.arg_scope([slim.conv2d, slim.max_pool2d],
                ...
                # --Bao edited--#
                net_1 = slim.conv2d(inputs, 16, 3, stride=2, scope='conv1')
                print(net_1)
                net_1 = slim.conv2d(net_1, 32, 3, stride=2, scope='conv2')
                print(net_1)
                net_1 = slim.conv2d(net_1, 64, 3, stride=2, scope='conv3')
                print(net_1)

                net_1 = slim.conv2d(net_1, 1, 1, stride=1, scope='conv4')
                print(net_1)
                save_net_1 = net_1
                ...
                print(net_1)
                net_1 = upsample(net_1, inputs.get_shape()[1:3])
                print(net_1)

                net = tf.multiply(inputs, net_1)

                # 100 x 24 x 32
                # 149 x 149 x 32
                net = slim.conv2d(net, 32, 3, stride=2, padding='VALID',
                                  scope='Conv2d_1a_3x3')
                ...
                net = slim.repeat(net, 3, block17, scale=0.10)
                print(net)
